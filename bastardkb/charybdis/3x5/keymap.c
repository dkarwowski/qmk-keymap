...
#define _POINTER_MOD(L00, L01, L02, L03, L04, R00, R01, R02, R03, R04, L10, L11, L12, L13, L14, R10, R11, R12, R13, R14, L20, L21, L22, L23, L24, R20, R21, R22, R23, R24, ...) L00, L01, L02, L03, L04, R00, R01, R02, R03, R04, L10, L11, L12, L13, L14, R10, R11, R12, R13, R14, LT(TRACK, L20), L21, L22, L23, L24, R20, R21, R22, R23, LT(TRACK, R24), __VA_ARGS__
#define POINTER(...) _POINTER_MOD(__VA_ARGS__)

#define LAYOUT_wrap(...) LAYOUT_split_3x5_3(__VA_ARGS__)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_wrap(POINTER(LAYOUT_KC(LAYOUT_BASE))), [TRACK] = LAYOUT_wrap(LAYOUT_KC(LAYOUT_TRACK)), [SYM] = LAYOUT_wrap(LAYOUT_KC(LAYOUT_SYM)), [NUM] = LAYOUT_wrap(LAYOUT_KC(LAYOUT_NUM)), [FUN] = LAYOUT_wrap(LAYOUT_KC(LAYOUT_FUN)), [NAV] = LAYOUT_wrap(LAYOUT_KC(LAYOUT_NAV)), [SET] = LAYOUT_wrap(LAYOUT_KC(LAYOUT_SET)),
};
